...
ATTRIBUTE_TYPES = {
    ...
    Attribute.HSS_LEVELS: _ulong,
    Attribute.HSS_LMS_TYPE: _ulong,
    Attribute.HSS_LMS_TYPES: _ulong,
    Attribute.HSS_LMOTS_TYPE: _ulong,
    Attribute.HSS_LMOTS_TYPES: _ulong,
    Attribute.HSS_KEYS_REMAINING: _ulong,
    Attribute.ID: _bytes,
